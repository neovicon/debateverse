...
const Login = () => {
  ...
  useEffect(() => {
    document.title = 'Login | DebateVerse';
  }, []);
  ...
  return (
    <div className="flex justify-center items-center mt-8 md:mt-20 px-4">
      ...
      >
        <h2 className="text-2xl md:text-3xl font-bold mb-6 text-center neon-text-blue">Access Terminal</h2>
        <form onSubmit={onSubmit} className="space-y-6">
          ...
          <button type="submit" className="w-full btn-neon-blue py-3 mt-4 text-base md:text-lg" disabled={isLoading}>
